...
static const char *const pkey_priv_tags[] = {
    "priv", /* DH, DSA, EC, ECX (X25519/Ed25519), SM2, ML-*, SLH-DSA */
    "d", /* RSA, RSA-PSS */
};
...
static int do_pkey_all_gettables_probe(EVP_PKEY *pkey, const char *keytype)
{
    ...
    for (i = 0; i < n; i++) {
        ...
        case OSSL_PARAM_UTF8_STRING:
            ...
            break;
        default:
            /* PTR types already populated; REAL / unknown left as-is. */
            break;
        }
    }
...
typedef struct pkey_test_spec_st {
    ...
    size_t der_len; /* size of the DER blob when set */
