...
PKCS12_SAFEBAG_get1_skey - Get objects from a PKCS#12 safeBag
...
PKCS12_SAFEBAG_get1_skey() converts a decrypted B<PKCS8_PRIV_KEY_INFO> (as
...
PKCS12_SAFEBAG_get1_skey() was added in OpenSSL 4.1.
