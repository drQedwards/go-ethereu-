...
- **Bag-level extraction**: Add `PKCS12_SAFEBAG_get1_skey()` in `p12_sbag.c`,
...
Convert: `PKCS12_SAFEBAG_get1_skey`

**File**: `crypto/pkcs12/p12_sbag.c`

```c
EVP_SKEY *PKCS12_SAFEBAG_get1_skey(const PKCS8_PRIV_KEY_INFO *p8inf,
